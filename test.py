...
# # Run test loop on first 10 samples
...
#     visualize_prediction(image.cpu(), predicted_density.cpu(), target_density, idx)
...
mae = 0.0
mse = 0.0
max_samples = 10  # Change this if you want to test on more images
